...
const Navigation = () => {
  ...
  return (
    ...
    >
      <Grid item sx={{ mr: 2 }}>
        <IconButton size="medium" className='nav_menu active' onClick={() => navigate('/member-list')}>
          <DocumentCode2 variant="Bulk" />
          <Typography variant="subtitle1">회원관리</Typography>
        </IconButton>
      </Grid>
      <Grid item sx={{ mr: 2 }}>
        <IconButton size="medium" className='nav_menu' onClick={() => navigate('/order-list')}>
          <I24Support variant="Bulk" />
          <Typography variant="subtitle1">결제내역관리</Typography>
        </IconButton>
      </Grid>
      <Grid item sx={{ mr: 2 }}>
        <IconButton size="medium" className='nav_menu' onClick={() => navigate('/subscribe-list')}>
